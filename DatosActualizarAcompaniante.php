...
<?php 
        ...
        $sql = "SELECT * FROM acompaniante WHERE no_documento='$no_documento'";
        if(!$result = $db->query($sql)){
         die('Hay un error corriendo en la consulta o datos no encontrados!!! [' . $db->error . ']');
                }
            while($row = $result->fetch_assoc())
            {
                $id_acompaniante=stripslashes($row["id_acompaniante"]);
            ...
            <div class='row justify-content-center'>
             ...
             <form class='p-4' method='POST' action='ActualizarDatosAcompaniante.php' enctype='multipart/form-data'>
            ...
            <div class=''>
                ...
                <div class=''>
                    ...
                    <input class='controls' type='hidden' name='id_acompaniante' value='$id_acompaniante'>
                ...
                <div class='row'>
                    ...
                    <div class='row'>
                        ...
                        <div  class='col-md-4 mb-3'>
                          ...
                          <center> <input type='submit' class='btn btn-primary' value='ACTUALIZAR ACOMPAÑANTES'></center> 
                        </br>
                        </br>
                                 <hr  />
                        </br>
