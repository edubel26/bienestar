					...
					<div class="wrap d-md-flex">
			      	...
			      	<div class="d-flex">
			      		<div class="w-100">
							...
							<form action="restablecer.php" method="POST"  class="signin-form">

							<div class="form-group mb-3">
			      				<label class="label">N° De documento</label>
			      				<input name="documento" type="text" class="form-control" placeholder="Numero de documento" required>
			      			</div>	
			      			<div class="form-group mb-3">
			      				<label class="label">Correo de verificacion</label>
